    ...
    */
    ...
    //PT 1 
        //if % 3 === 0 , then print fizz
        //if % 5 === 0, then print buzz
        //else print number 
    ...
    */
    //PT 2
    // add new condition using && for both, p much the same
    for(let i = 1; i <= 100; i++) {
        if ((i % 3 === 0) && (i % 5 === 0)) {
    ...
    */
    ...
    function eightByEightChessboard() {
        const chessBoard = " # # # # \n# # # #  \n"
        repeatedChessBoard = chessBoard.repeat(4)
        console.log(repeatedChessBoard)
    }
    eightByEightChessboard()


    //ask for size
    //when size is given, output the amount
